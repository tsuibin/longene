...
#ifndef _WINESERVER_WINCON_H
#define _WINESERVER_WINCON_H
...
WINBASEAPI BOOL WINAPI   FillConsoleOutputAttribute(HANDLE hConsoleOutput, WORD wAttribute, DWORD nLength,
...
WINBASEAPI BOOL WINAPI   GetConsoleCursorInfo(HANDLE hcon, LPCONSOLE_CURSOR_INFO cinfo);
WINBASEAPI BOOL WINAPI   GetConsoleMode(HANDLE hcon,LPDWORD mode);
WINBASEAPI UINT WINAPI   GetConsoleOutputCP(VOID);
WINBASEAPI BOOL WINAPI   GetConsoleScreenBufferInfo(HANDLE hConsoleOutput,
...
WINBASEAPI BOOL WINAPI   GetNumberOfConsoleInputEvents(HANDLE hcon,LPDWORD nrofevents);
WINBASEAPI BOOL WINAPI   GetNumberOfConsoleMouseButtons(LPDWORD nrofbuttons);
WINBASEAPI BOOL WINAPI   PeekConsoleInputA(HANDLE handle, PINPUT_RECORD buffer, DWORD count, LPDWORD read);
...
WINBASEAPI BOOL WINAPI   ReadConsoleA(HANDLE hConsoleInput, LPVOID lpBuffer, DWORD nNumberOfCharsToRead,
		LPDWORD lpNumberOfCharsRead, LPVOID lpReserved);
WINBASEAPI BOOL WINAPI   ReadConsoleW(HANDLE hConsoleInput, LPVOID lpBuffer, DWORD nNumberOfCharsToRead,
		LPDWORD lpNumberOfCharsRead, LPVOID lpReserved);
#define       ReadConsole WINELIB_NAME_AW(ReadConsole)
WINBASEAPI BOOL WINAPI   ReadConsoleInputA(HANDLE hConsoleInput, PINPUT_RECORD lpBuffer, DWORD nLength,
		LPDWORD lpNumberOfEventsRead);
WINBASEAPI BOOL WINAPI   ReadConsoleInputW(HANDLE hConsoleInput, PINPUT_RECORD lpBuffer, DWORD nLength,
		LPDWORD lpNumberOfEventsRead);
#define       ReadConsoleInput WINELIB_NAME_AW(ReadConsoleInput)
WINBASEAPI BOOL WINAPI   ReadConsoleOutputA(HANDLE hConsoleOutput, LPCHAR_INFO lpBuffer, COORD dwBufferSize,
		COORD dwBufferCoord, LPSMALL_RECT lpReadRegion);
WINBASEAPI BOOL WINAPI   ReadConsoleOutputW(HANDLE hConsoleOutput, LPCHAR_INFO lpBuffer, COORD dwBufferSize,
		COORD dwBufferCoord, LPSMALL_RECT lpReadRegion);
#define       ReadConsoleOutput WINELIB_NAME_AW(ReadConsoleOutput)
WINBASEAPI BOOL WINAPI   ReadConsoleOutputAttribute(HANDLE hConsoleOutput, LPWORD lpAttribute, DWORD nLength,
...
WINBASEAPI BOOL WINAPI   ScrollConsoleScreenBufferA(HANDLE hConsoleOutput, LPSMALL_RECT lpScrollRect,
		LPSMALL_RECT lpClipRect, COORD dwDestOrigin,
		LPCHAR_INFO lpFill);
WINBASEAPI BOOL WINAPI   ScrollConsoleScreenBufferW(HANDLE hConsoleOutput, LPSMALL_RECT lpScrollRect,
		LPSMALL_RECT lpClipRect, COORD dwDestOrigin,
		LPCHAR_INFO lpFill);
...
WINBASEAPI BOOL WINAPI   SetConsoleCtrlHandler(PHANDLER_ROUTINE func, BOOL add);
WINBASEAPI BOOL WINAPI   SetConsoleCursorInfo(HANDLE hcon, LPCONSOLE_CURSOR_INFO cinfo);
...
WINBASEAPI BOOL WINAPI   SetConsoleWindowInfo(HANDLE hcon, BOOL bAbsolute, LPSMALL_RECT window);
WINBASEAPI BOOL WINAPI   WriteConsoleA(HANDLE, CONST VOID *,DWORD,LPDWORD,LPVOID);
WINBASEAPI BOOL WINAPI   WriteConsoleW(HANDLE, CONST VOID *lpBuffer, DWORD,LPDWORD,LPVOID);

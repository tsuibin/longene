...
void manage_desktop( WCHAR *arg )
{
    ...
    hwnd = CreateWindowExW( 0, DESKTOP_CLASS_ATOM, NULL,
                            ...
                            0, 0, 0, NULL );
    LOG(LOG_FILE, 0, 0, "hwnd %p, atom %s\n", hwnd, wine_dbgstr_w(DESKTOP_CLASS_ATOM));
    ...
    {
        LOG(LOG_FILE, 0, 0, "not desktop window\n");

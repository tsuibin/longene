	...
	LPOPENFILENAMEA ofn) /* [in/out] address of init structure */
{
    ...
    GetClassNameA(ofn->hwndOwner, class_name, sizeof(class_name)/sizeof(class_name[0]) );
	...
	LPOPENFILENAMEW ofn) /* [in/out] address of init structure */
{
    ...
    GetClassNameW(ofn->hwndOwner, class_name, sizeof(class_name)/sizeof(class_name[0]) );
